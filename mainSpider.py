...
class zk_spider():
    def __init__(self):
        ...
        while 1:
            ...
            if Input == '1':
                ...
                print('自动判断学期为{}'.format(options_seme))
    ...
    def get_cookies(self):
        with open('cookies.cok', 'w')as f:
            ...
            print(str(self.zk_user.home_cookies)+'sb')
            print('登录cookie已保存')
    def Login__(self,hot=True):
        # select_mode = input('请输入登录模式，a是自动登录，其他字符是手动登录')
    ...
    def Get_curriculum(self, semester):
        ...
        with open('{}.jpg'.format(semester), 'wb') as f:
            ...
            print('成功下载{}时间的课表'.format(semester))
